...
class _EditVehicleScreenState extends ConsumerState<EditVehicleScreen> {
  ...
  late final TextEditingController _ownerDocTypeController;
  late final TextEditingController _ownerDocNumController;
  ...
  void initState() {
    ...
    _ownerDocTypeController = TextEditingController(text: widget.vehicle.ownerDocumentType);
    _ownerDocNumController = TextEditingController(text: widget.vehicle.ownerDocumentNumber);
  }
  ...
  Future<void> _updateVehicle() async {
    ...
    try {
      final updatedVehicle = Vehicle(
        id: widget.vehicle.id, // Keep the same ID
                ...
                child: _isLoading
                    ...
                    : const Row(
                        ...
                        children: [
                          ...
                          SizedBox(width: 8),
                          Text('Actualizar Vehículo', style: TextStyle(fontSize: 16)),
                        ],
                      ),
              ),
            ],
